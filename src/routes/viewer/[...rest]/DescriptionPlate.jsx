        ...
        <>
            <div className="flex flex-row items-center justify-between border-y" onClick={onClick}>
                <div className="flex items-center sticky top-0 bg-white z-10">
                    <label className={`ml-3 text-lg my-2 ${(label === 'Patient'|| label === "Study") ? ("text-black"):("text-green-400")} font-sans font-bold`}>{label}</label>
                ...
                <div className="flex mr-5 items-center">
                    ...
                    <Icon
                        icon={!isOpen
                            ...
                            : (label === "Specimens" || label === "Slide label")
                                ? ""
